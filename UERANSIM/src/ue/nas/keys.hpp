...
//tahap-9 //Prime-FS
/**
 * Calculates mkFS for EAP-AKA' according to given parameters as specified in RFC 9678.
 */
...
/**
 * Calculates K_AUSF for EAP-AKA' FS according to given parameters as specified in 3GPP TS 33.501 Annex F.
 */
