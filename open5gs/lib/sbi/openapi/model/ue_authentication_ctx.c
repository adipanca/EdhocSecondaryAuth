...
cJSON *OpenAPI_ue_authentication_ctx_convertToJSON(OpenAPI_ue_authentication_ctx_t *ue_authentication_ctx)
{
    ...
    // //tahap-2
    if (ue_authentication_ctx->auth_type == OpenAPI_auth_type_EAP_AKA_PRIME) {
...
OpenAPI_ue_authentication_ctx_t *OpenAPI_ue_authentication_ctx_parseFromJSON(cJSON *ue_authentication_ctxJSON)
{
    ...
    //tahap-2
    if (_5g_auth_data && auth_typeVariable == OpenAPI_auth_type_5G_AKA) {
        if (!_5g_auth_data) {
    ...
    // //tahap-2
    if (auth_typeVariable == OpenAPI_auth_type_EAP_AKA_PRIME) {
        ue_authentication_ctx_local_var->eap_payload = eap_payload_str;
    }
    // //end
