        ...
        amf_ue_t *amf_ue, ogs_nas_5gs_message_t *message)
{
    ...
    *(uint8_t *)(new->data) = h.sequence_number;
    ...
    ogs_info("[%s] Security context marked as available", amf_ue->suci);
    ogs_info("[%s] security_context_available = %d", amf_ue->supi, amf_ue->security_context_available);
    ogs_info("[%s] mac_failed = %d", amf_ue->supi, amf_ue->mac_failed);
    ogs_info("[%s] nas.ue.ksi = %d", amf_ue->supi, amf_ue->nas.ue.ksi);
    //end
